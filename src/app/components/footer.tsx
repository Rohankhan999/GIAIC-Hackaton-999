...
function Footer() {
  ...
  <div className="bg-[#E7E4F8]">
    <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
      ...
      <Link 
      target='blank' href={"https://github.com/Rohankhan999"} className="text-black">
      <FaGithub className='text-3xl ' />
      </Link>

      <Link
      target='blank' href={"https://vercel.com/rohankhan999s-projects"} className="ml-3 text-black">
      <IoLogoVercel className='text-3xl' />
      </Link>
      
      <Link
      target='blank' href={"https://www.linkedin.com/in/rohan-khan-32317129b/"} className="ml-3 text-black">
